...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.phone) newErrors.phone = 'Nomor WhatsApp diperlukan';
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      setErrors({
        submit: err.message || 'Registrasi gagal. Silakan coba lagi.',
      });
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="flex-1 max-w-md w-full mx-auto px-6 py-8 flex flex-col">
          ...
          <form className="space-y-4 flex-1">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1.5 ml-1">Konfirmasi Password</label>
                <Input
                  type="password"
                  icon={<Lock size={18} />}
